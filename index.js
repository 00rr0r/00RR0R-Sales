...
process.env.PROJECT_ADDRESS='HEYageWQtfnfYrx1VQKPn2eygkAQqAdDF3pJNbe2SDZt'; 
process.env.DISCORD_URL='https://discord.com/api/webhooks/912742817032470578/dgYcn4B2ICiHz_Ab-AOfHL5mVCxKRzsSKCsyZNgss7F6OHARY0FfWTurviOE25KmB_YH';
    ...
    axios.post(process.env.DISCORD_URL,
        {
            "embeds": [
                {
                    "title": `AN 00RR0R HAS BEEN SOLD`,
                    "description": `00RR0R ${title}`,
                    "fields": [
                        {
                            "name": "Price",
                            "value": `${price} SOL`,
